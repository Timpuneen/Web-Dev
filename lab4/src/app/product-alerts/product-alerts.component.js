...
var ProductAlertsComponent = function () {
    ...
    var ProductAlertsComponent = _classThis = /** @class */ (function () {
        function ProductAlertsComponent_1() {
            this.product = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _product_initializers, void 0));
            this.notify = __runInitializers(this, _notify_initializers, new core_1.EventEmitter());
        }
        return ProductAlertsComponent_1;
    }());
