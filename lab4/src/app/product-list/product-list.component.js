...
var ProductListComponent = function () {
    ...
    var ProductListComponent = _classThis = /** @class */ (function () {
        ...
        ProductListComponent_1.prototype.share = function (productLink) {
            var telegramShareUrl = "https://t.me/share/url?url=".concat(encodeURIComponent(productLink));
            window.open(telegramShareUrl, '_blank');
        };
        ProductListComponent_1.prototype.onNotify = function () {
